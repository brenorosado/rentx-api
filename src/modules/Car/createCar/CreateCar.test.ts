...
describe("POST at /car", () => {
  ...
  it.each([
    ["missing name", { name: "" }],
    ["missing manufacturer", { manufacturer: "" }],
    ["missing pricePerDay", { pricePerDay: 0 }],
    ["missing maxSpeed", { maxSpeed: 0 }],
    ["missing zeroToAHundredTime", { zeroToAHundredTime: 0 }],
    ["missing fuelType", { fuelType: "" }],
    ["missing gear", { gear: "" }],
    ["missing maxPeople", { maxPeople: 0 }],
    ["missing horsePower", { horsePower: 0 }],
